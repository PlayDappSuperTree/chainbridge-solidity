...
contract Bridge is Pausable, AccessControl {
    ...
    bytes32 public constant RELEASE_ETH_FUND_ROLE = keccak256("RELEASE_ETH_FUND_ROLE");
    ...
    function _onlyTrustedHandlers() private {
        require(hasRole(RELEASE_ETH_FUND_ROLE, msg.sender), "sender doesn't have release ETH fund role");
    }
