...
contract('E2E ERC20 - Two EVM Chains', async accounts => {
  ...
  beforeEach(async () => {
    ...
    originDepositProposalData = Helpers.createERCDepositProposalData(depositAmount, 20, recipientAddress);
    ...
    destinationDepositProposalData = Helpers.createERCDepositProposalData(depositAmount, 20, depositerAddress);
